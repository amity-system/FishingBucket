...
def setup():
    ...
    async def _(context: Context, stat: str | None):
        ...
        stats = {
            ...
            "proxy_uses": ("Total proxy uses", str(int(db_stats.get("proxy_uses", 0)))),
            "total_proxies": ("Total registered proxies", str(int(db_stats.get("total_proxies", 0)))),
            ...
            "database_version": ("Database version", str(int(db_stats.get("version", -1)))),
